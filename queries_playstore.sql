...
SELECT app_name, price, rating FROM analytics WHERE rating IS NOT NULL AND price >= .10 AND price <= 1.00 OR
DER By rating DESC;
...
FROM analytics WHERE min_installs >= 10000 ORDER BY proportion DESC;